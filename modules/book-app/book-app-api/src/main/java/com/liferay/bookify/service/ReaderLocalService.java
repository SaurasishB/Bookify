...
/**
 * Provides the local service interface for Reader. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ReaderLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ReaderLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.bookify.service.impl.ReaderLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the reader local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ReaderLocalServiceUtil} if injection and service tracking are not available.
	 */
	public Reader addReader(long groupId, String readerName)
	...
	public Reader updateReader(long readerId, String readerName)
		throws PortalException;
